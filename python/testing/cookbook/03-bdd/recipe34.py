...
def test_behave_scenarios():
    features = '/features'
    print("Running suite recipe32")
    os.system("behave %s" % os.path.abspath("recipe32/features"))
    print()
    print("Running suite recipe33")
    os.system("behave %s" % os.path.abspath("recipe33/features"))
    print()
...
if len(optlist) == 0:
    usage()
    sys.exit(1)
# Check for help requests, which cause all other options to be ignored.
