...
class CartThatWeWillSaveAndRestoreUsingMock(unittest.TestCase):
    """
    Cart that we will save and restore using Mock
    """
    def test_fill_up_a_cart_then_save_it_and_restore_it(self):
        ...
        # Save the cart at this point in time into a database using a mock
        ...
        # Restore the cart to the last store point in time
        cart.restore(id)
        self.assertEquals(2, len(cart))
